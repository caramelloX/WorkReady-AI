...
export default function StudentProfile({ avatarBase64, initials, fullName, targetTrack, major, educationLevel, occupationGoal, targetIndustry, email, bio, careerGoal, strengthsList, developAreasList }) {
  const { t } = useLanguage();
  return (
    <div className="student-tab-panel">
            ...
            <div className="profile-grid">
                  ...
                  {(educationLevel || major) && (
                    <div className="profile-details-section">
                      ...
                      <span className="profile-detail-val">
                        {educationLevel && major ? `${educationLevel} — ${major}` : educationLevel || major}
                      </span>
                    </div>
                  )}
              ...
              <div className="profile-right-grid">
                ...
                {(bio || occupationGoal) && (
                  <div className="student-card">
                    ...
                    <p className="profile-about-text">
                      {bio || t('profile.aboutDesc').replace('{0}', occupationGoal)}
                    </p>
                  </div>
                )}
                ...
                {(strengthsList.length > 0 || developAreasList.length > 0) && (
